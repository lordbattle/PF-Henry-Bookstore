...
//   userFilterAndPagination,
// } = require("../helpers/userFilterAndPagination");
// const asyncAwaitHooks = require("async-await-hook");
...
//   try {
//     console.log("controller", active);
//     const statusBoolean = JSON.parse(active);
...
// const registerUser = async (data) => {
//   // Mostrar mensaje de carga antes del inicio del registro
//   asyncAwaitHooks.runBefore("registerUser");
...
//     // Ocultar mensaje de carga después de completar el registro
//     asyncAwaitHooks.runAfter("registerUser");
