    ...
    return (
        <div>
            ...
            <Card style={{ width: '20rem' }}>
                ...
                <Card.Body>
                <Card.Title><h2>Lisandro Daniel Pereyra</h2></Card.Title>
                <Card.Text>
            ...
            <Card style={{ width: '20rem' }}>
                <Card.Img variant="top" src="https://www.unjobnet.org/assets/images/users/blank-profile.png" />
                <Card.Body>
                <Card.Title><h2>Lucas Leonardo Robledo</h2></Card.Title>
                <Card.Text>
                <p style={{ fontSize: '26px'}}>Contactos: </p>
            ...
            <Card style={{ width: '20rem' }}>
                <Card.Img variant="top" src="https://www.unjobnet.org/assets/images/users/blank-profile.png" />
                <Card.Body>
                <Card.Title><h2>Franco Chiovetta Falconier</h2></Card.Title>
                <Card.Text>
                <p style={{ fontSize: '26px'}}>Contactos: </p>
            ...
            <Card style={{ width: '20rem' }}>
                <Card.Img variant="top" src="https://www.unjobnet.org/assets/images/users/blank-profile.png" />
                <Card.Body>
                <Card.Title><h2>Diego Hanssel Perez</h2></Card.Title>
                <Card.Text>
                <p style={{ fontSize: '26px'}}>Contactos: </p>
            ...
            <Card style={{ width: '20rem' }}>
                <Card.Img variant="top" src="https://www.unjobnet.org/assets/images/users/blank-profile.png" />
                <Card.Body>
                <Card.Title><h2>Cesar Daniel Sell</h2></Card.Title>
                <Card.Text>
                <p style={{ fontSize: '26px'}}>Contactos: </p>
            ...
            <Card style={{ width: '20rem' }}>
                <Card.Img variant="top" src="https://www.unjobnet.org/assets/images/users/blank-profile.png" />
                <Card.Body>
                <Card.Title><h2>David Antonio Escobar Zuñiga</h2></Card.Title>
                <Card.Text>
                <p style={{ fontSize: '26px'}}>Contactos: </p>
            ...
            <Card style={{ width: '20rem' }}>
                <Card.Img variant="top" src="https://www.unjobnet.org/assets/images/users/blank-profile.png" />
                <Card.Body>
                <Card.Title><h2>Johan David Rodriguez Ruiz</h2></Card.Title>
                <Card.Text>
                <p style={{ fontSize: '26px'}}>Contactos: </p>
            ...
            <Card style={{ width: '20rem' }}>
                <Card.Img variant="top" src="https://www.unjobnet.org/assets/images/users/blank-profile.png" />
                <Card.Body>
                <Card.Title><h2>Naycol Rodolfo Linares Villasmil</h2></Card.Title>
                <Card.Text>
                <p style={{ fontSize: '26px'}}>Contactos: </p>
