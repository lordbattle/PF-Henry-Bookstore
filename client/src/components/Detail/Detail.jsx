...
const Detail = () =>{
    ...
    useEffect(() => {
      ...
      }, [title, subtitle, price, stock, authors, description, bookPic, averageRating, genre, pages, publishedDate, publisher, identifier]);
    ...
    return (
        <div className={style.main}>
           ...
           {!isEditing && (
            ...
            <p style={{width: '50%', fontSize: '20px'}}>Global rating: {averageRating}</p> <p style={{width: '50%', fontSize: '20px'}}>User rating: {userRating}</p>
