  ...
  return (
    <div className={styles.containerForm}>
      ...
      <form className="d-flex flex-column align-items-center gap-2" onSubmit={handleSubmit(onSubmit)}>
        ...
        {imagePreview && <img src={imagePreview} alt="Profile Preview" className={styles.profilePic} />}
      ...
      <div className="_dropdown_toggle_15isk_51">
        {userChange.name}
        {imagePreview && <img src={imagePreview} alt="Profile" className={styles.profilePicDropdown} />}
      </div>
    </div>
  );
};
